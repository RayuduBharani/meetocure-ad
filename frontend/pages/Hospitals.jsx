...
const Hospitals = () => {
  ...
  const fetchHospitals = async () => {
    try {
      ...
      const response = await fetch('http://13.201.62.186:8000/admin/hospitals');
  ...
  const fetchStats = async () => {
    try {
      ...
      const response = await fetch('http://13.201.62.186:8000/admin/hospitals/stats');
  ...
  const confirmDeleteHospital = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://13.201.62.186:8000/admin/hospitals/${hospitalToDelete._id}`,
        {
          method: 'DELETE',
        }
      );
