...
const Patients = ({ searchQuery = '' }) => {
    ...
    const fetchPatients = async () => {
        try {
            setLoading(true);
            const response = await fetch('http://13.201.62.186:8000/admin/patients');
    ...
    const handleRegisterPatient = async (e) => {
        ...
        try {
            const response = await fetch('http://13.201.62.186:8000/admin/patients/register', {
                method: 'POST',
                headers: {
    ...
    const handleDeletePatient = async () => {
        ...
        try {
            const response = await fetch(`http://13.201.62.186:8000/admin/patients/${patientToDelete.patientId}`, {
                method: 'DELETE',
            });
    ...
    const fetchPatientProfile = async (patient) => {
        ...
        try {
            const response = await fetch(`http://13.201.62.186:8000/admin/patients/${patient.patientId}/appointments`);
            const data = await response.json();
